...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            in.close();
            GoodsTransfer.parser(buf.toString());
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    private void testJson(){
        ...
        JsonAdapter<PriceViewItem> jsonAdapter=moshi.adapter(PriceViewItem.class);
        try {
            PriceViewItem priceUpdateItem=jsonAdapter.fromJson(json);
